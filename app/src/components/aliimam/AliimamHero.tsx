  ...
  return (
    <div className="relative flex h-screen items-center justify-center">
      ...
      <div className="container flex flex-col text-center z-10 px-6">
        <h2 className="z-10 pt-10 text-5xl font-extrabold tracking-tighter md:text-7xl lg:text-9xl text-foreground">
          {title}
        </h2>
        <div className="z-10 flex flex-col items-center justify-center space-y-6 px-6 pt-10 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            ...
            <a href={secondaryHref}>
              <button className="h-12 cursor-pointer px-8 md:h-14 md:px-10 border border-border text-foreground font-medium text-sm rounded-none hover:bg-card transition-colors">
                {secondaryLabel}
              </button>
            </a>
          </div>
