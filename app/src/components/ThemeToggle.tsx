...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="inline-flex items-center justify-center border border-border text-muted-foreground hover:text-foreground hover:bg-border h-8 w-8 transition-colors cursor-pointer"
    >
